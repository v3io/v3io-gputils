...
def version():
    with open('v3io_gputils/__init__.py') as fp:
        for line in fp:
...
setup(
    name='v3io_gputils',
    version=version(),
    description='GPU utilities for v3io',
    long_description=long_desc,
    long_description_content_type='text/markdown',
    author='Tal Neiman',
    author_email='taln@iguazio.com',
    license='MIT',
    url='https://github.com/v3io/v3io-gputils',
    packages=['v3io_gputils'],
